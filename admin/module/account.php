<?php
	...
	if(isset($_POST['doimk']))
	{
		...
		if($checkmk == 1)
		{
			...
			$kq = mysql_query("SELECT MatKhau FROM NhanVien WHERE MaNV = '".$_SESSION['user']."'");
		...
		if($checkmk)
		{
			...
			$kq = mysql_query("UPDATE NhanVien SET MatKhau = N'$pass_md5' WHERE MaNV = '".$_SESSION['user']."'");
...
<form method = "post">
            ...
            <table class = "info_account" cellspacing="20px" width="100%">
                ...
                <tr>
                    ...
                    <td><input type = "password" class='txt-sp' name = "pass_hientai" value = ""/></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type = "password" class="txt-sp" name = "pass_moi" value = ""/></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type = "password" class="txt-sp" name = "confirm_pass" value = ""/></td>
                </tr>
            	...
            	<tr>
                	<td></td>
                    <td><input type = "submit" name = 'doimk' style="width: 220px" class = "sub" value = "CẬP NHẬT" /></td>
                </tr>
